...
const InvoiceCreationSheep = ({ seSelectedInvoices }) => {
  ...
  return (
    <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          <SheetTitle>
            <Label className="p-2 text-sm font-semibold text-purple-700 bg-purple-100 rounded-sm">
              {" "}
              Add Invoice{" "}
            </Label>
          </SheetTitle>
          <SheetDescription className=" p-0 ">
            <div className="flex flex-col items-center justify-center w-full mt-10 ">
              <Form {...form}>
                <form
                  onSubmit={form.handleSubmit(addInvoice)}
